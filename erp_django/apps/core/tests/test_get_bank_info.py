...
class TestCreateUser(TransactionTestCase):
    ...
    def setUp(self):
        ...
        self.dev_1 = Developer.objects.create(
        ...
        self.dev_2 = Developer.objects.create(
            password=make_password("some_password"),
            type="DEVELOPER",
            username='uvik_dev2',
            first_name="DEV_2",
    ...
    def test_get_bank_info_authorized_without_perms(self):
        fake_user = User.objects.create(username="fake_user", password=make_password("password"), type="CLIENT")
