...
from .views import InvoiceViewSet, ManagerInfoViewSet, ProjectViewSet, ServicesViewSet, DeveloperViewSet, \
    DevelopersOnProjectViewSet, ClientViewSet, GenerateInvoice, DaysOff, CvSearch, schema_view
...
urlpatterns = [url(r'', include(router.urls)),
               ...
               url(r'^swagger/$', schema_view)] + static(settings.STATIC_URL, document_root=settings.STATIC_ROOT)
