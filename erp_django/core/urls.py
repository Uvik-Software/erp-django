...
from .views import InvoiceViewSet, ManagerInfoViewSet, ProjectViewSet, ServicesViewSet, DeveloperViewSet, \
    DevelopersOnProjectViewSet, ClientViewSet, GenerateInvoice, DaysOff, CvSearch
...
urlpatterns = [url(r'', include(router.urls)),
               ...
               url(r'^cv_search/$', CvSearch.as_view())] + static(settings.STATIC_URL, document_root=settings.STATIC_ROOT)
